...
Yes, InfoSec and ACE seminars are open to everyone! At the moment, we're fully virtual, so you just need to request the Zoom details or join the YouTube livestream. When we'll restart in-person, we'll post more details.
* *What's the difference between ACE and InfoSec Seminars?*  
ACE Seminars are part of our distinguished seminar series, organized with the support of, and funding from, the Academic Center of Excellence in Cyber Security Research ([ACE-CSR](https://www.ucl.ac.uk/cybersecurity-centre-of-excellence/)).  
