...
<!----->  
- March 2026 (date TBC), 16:00  
**Sergio Maffeis**  
Security & Machine Learning
[[Zoom](https://ucl.zoom.us/j/91912335448)]<details> **Abstract:** tba.<br><br>**Bio:** Sergio Maffeis received his PhD in theoretical computer science from Imperial College London, in 2006. He held two EPSRC Fellowships (2007-2015), and visiting positions at UC Santa Cruz, Stanford University, Microsoft Research (Silicon Valley) and INRIA (Paris). He is currently an Associate Professor in Computer Security at Imperial, where he leads the Security & Machine Learning lab. His research interests include security, artificial intelligence and formal methods.<br></details>
<!----->  
<img src="../images/Isabel.jpg" style="float:right;width:100px;height:100px;margin-top:15px">
- 11 December, 16:00  
**Isabel Straw**  
Under the skin: Evaluating the cyber-resiliency of life-critical technologies from individual implants to international infrastructure  
[[Zoom](https://ucl.zoom.us/j/99748861205)]<details> **Abstract:** The rapid advancements in MedTech innovation and healthcare AI, paired with an ageing population that is increasingly reliant on digital therapeutics and connected “Health at home” services, has led to an expanding and unexplored threat landscape in healthcare. This talk will examine how cyberattacks and system vulnerabilities threaten life-critical technologies across the healthcare ecosystem, from hospital networks to implanted medical devices. Dr Isabel Straw will introduce CIPHER, an open-source software platform developed with the UC San Diego Centre for Healthcare Cybersecurity, which maps patient harms from cyber incidents across global hospitals, modelling how disruption unfolds over time. Building on this population-level analysis, the talk examines the growing risks within the “Internet of Medical Things” and human-machine interfaces, including recent collaborations with the UK Home Office on the “Cyborg Crime Scene” project investigating digitally mediated deaths and the forensic challenges of connected implants. The session concludes by considering how cyber-resilience can be redefined when the boundary between human and technology disappears. For those attending in person, live demos and prototypes of relevant bodily technologies will be available.<br><br>**Bio:** Dr Isabel Straw is Assistant Professor in "Healthcare Artificial Intelligence and Cybersecurity" at University College London and a practising NHS Emergency Doctor. Her research focuses on the intersection of AI, healthcare, and critical infrastructure security, shaping UK and international policy on AI governance and healthcare cyber-resiliency, with contributions to United Nations and World Health Organization frameworks. An expert for INTERPOL on neurotechnology and AI, she advises on emerging digital risks and responsible technology use. She leads the open-source CIPHER Platform, which models patient harm from healthcare cyberattacks and works closely with the UK Home Office and national security agencies to advance cyber-resilience and risk mitigation across connected health systems.<br></details>
<!----->  
FAQs
---
