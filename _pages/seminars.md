...
[[Zoom](https://ucl.zoom.us/j/91284447839?)]<details> **Abstract:** Most public-key cryptography that is deployed in today’s systems is susceptible to attacks by quantum computers. This includes widely studied primitives such as RSA or the Diffie-Hellman key exchange. With increasing investment into the development of large-scale quantum computers, it is important to develop cryptography that is secure against both classical and quantum attacks. In light of this, in 2016, NIST began an effort to standardise post-quantum cryptography, bringing large interest to this field.

In this talk, I aim to give a gentle introduction to post-quantum cryptography for those who want to start delving into the topic, or for those wanting a better overview of the field. We will explore three main questions:
- Why do we need post-quantum cryptography?
- What are the main types of post-quantum cryptography that could be deployed in the future?
